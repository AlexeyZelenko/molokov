...
export const useAreasStore = defineStore('areas', {
    state: () => ({
        ...
        areas: [
            ...
            { name: 'Водоканал', code: 'VOD', position: { lat: 49.42808637639345, lng: 32.05982208251953 }, radius: 600, color: '#0000FF'},
            ...
            { name: 'Яблуневий', code: 'MOL', position: { lat: 49.41011721110426, lng: 32.08666772656333 }, radius: 500, color: '#a3edce' },
            ...
            { name: 'Сади', code: 'OBO', position: { lat: 49.40443881421899, lng: 32.077503261744546 }, radius: 900, color: '#eda3d2' },
            ...
            { name: 'Руставі', code: 'SHK', position: { lat: 49.43854424498209, lng: 32.00961112976074 }, radius: 900, color: '#50bf5f' },
        ],
        realEstateItems: [
            {
                id: 1,
