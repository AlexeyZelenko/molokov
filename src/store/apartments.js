    ...
    state: () => ({
        dropdowns: {
            areas: [
                ...
                { name: 'Вантажний порт', code: 'VAN', position: { lat: 49.4355, lng: 32.098 }, radius: 700, color: '#00FF00' },
            ...
            regions: [
                { name: 'Черкаська', code: 'Cherkaska' },
                { name: 'Вінницька', code: 'Vinnytska' },
                { name: 'Волинська', code: 'Volynska' },
                { name: 'Дніпропетровська', code: 'Dnipropetrovska' },
                { name: 'Донецька', code: 'Donetska' },
                { name: 'АРК', code: 'ARK' },
                { name: 'Житомирська', code: 'Zhytomyrska' },
                { name: 'Закарпатська', code: 'Zakarpatska' },
                { name: 'Запорізька', code: 'Zaporizka' },
                { name: 'Київська', code: 'Kyivska' },
                { name: 'Кіровоградська', code: 'Kirovohradska' },
                { name: 'Луганська', code: 'Luhanska' },
                { name: 'Львівська', code: 'Lvivska' },
                { name: 'Миколаївська', code: 'Mykolaivska' },
                { name: 'Одеська', code: 'Odeska' },
                { name: 'Полтавська', code: 'Poltavska' },
                { name: 'Рівненська', code: 'Rivnenska' },
                { name: 'Сумська', code: 'Sumska' },
                { name: 'Тернопільська', code: 'Ternopilska' },
                { name: 'Харківська', code: 'Kharkivska' },
                { name: 'Херсонська', code: 'Khersonska' },
                { name: 'Хмельницька', code: 'Khmelnytska' },
                { name: 'Чернівецька', code: 'Chernivetska' },
                { name: 'Чернігівська', code: 'Chernihivska' },
                { name: 'Івано-Франківська', code: 'Ivano-Frankivska' }
            ],
            buildingTypes: [
                {
                    name: 'Цегляний',
