...
export default class Room extends Property {
    constructor(props = {}) {
        super(props);
    ...
    category = { name: 'Кімната', code: 'rooms' };
}

export class RoomSell extends Room {
    constructor(props = {}) {
...
export class RoomRent extends Room {
    constructor(props = {}) {
        super(props); // Виклик конструктора батьківського класу
...
export class RoomExchange extends Room {
    constructor(props = {}) {
        super(props); // Виклик конструктора батьківського класу
...
export class RoomRentDaily extends Room {
    constructor(props = {}) {
        super(props); // Виклик конструктора батьківського класу
