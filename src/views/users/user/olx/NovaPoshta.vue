<template>
    <div class="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg">
        ...
        <p v-if="selectedSettlement" class="text-green-600 font-semibold">
            Вибраний населений пункт: {{ selectedSettlement.Description }}
        </p>
    </div>
</template>
...
const filteredCities = computed(() => {
    return citiesNova.value.filter(city =>
        ...
        city.AreaDescription === selectedArea.value?.Description
    );
});
