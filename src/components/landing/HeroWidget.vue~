    ...
    <div class="hero-widget relative">
        <div id="hero" class="flex flex-col z-0 relative">
            <div class="hero-container flex flex-col items-center justify-start text-center pb-94">
                ...
                <p class="font-normal text-2xl leading-normal md:mt-4 text-gray-50 p-2">Ефективний пошук, управління та угоди в одному місці...</p>
            </div>
        </div>

        <div class="hero-search-container absolute left-1/2 transform -translate-x-1/2 -bottom-50 z-7 w-full">
            <HomeSearch />
        </div>
    </div>
</template>
